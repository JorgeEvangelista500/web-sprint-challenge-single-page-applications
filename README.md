...
1. In 1-2 sentences, explain what React's `useRouteMatch` hook is used for.
   It it very useful when using nested routes, because it allow you to change just a single parameter, instead of having to change to whole url.

1. How would you explain form validation to someone who has never programmed before?
   i would describe it a series of logical steps in order to check the user uses the application the way the developer intended.
1. In 1-2 sentences, define end to end testing.
   it refers to using to a type of testing that is focus on the user experience, focusing on the action the user does and if it gives the intended result
